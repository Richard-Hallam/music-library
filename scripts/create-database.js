// scripts/create-database.js// require the pg package
const { Client } = require('pg')
const path = require('path')

// capture first command line argument passed to this scriptconst 
envName = process.argv.slice(2)[0]

// this function decides whether to load .env or .env.test.const 
loadEnv = (envName) => {
...
const databaseName = process.env.PGDATABASE432
